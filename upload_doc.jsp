...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
       <ul>
          ...
          <li><a href="pigmydeposite.html"><span>deposite</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Upload Document</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"></div>
...
session.setAttribute("s9",s9);
			...
			%>
			<form enctype="multipart/form-data" method="post" action="customerdetailsinsert.jsp">
			<table width="456" height="184">
    
    <tr>
      <td width="182"><span class="style1">Upload Document</span></td>
      <td width="262"><label>
